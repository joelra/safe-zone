...
public final class SafeZoneText {
	...
	public static String unknownSubcommand(String label) {
		return "Unknown subcommand. Use /" + label + " help.";
	}

	public static String playerStatusTitle() {
		return "Safe Zone Status";
	}

	public static String playerOwnedSummary(int ownedClaims, int maxClaims, int trustedClaims) {
		return "You own " + ownedClaims + "/" + maxClaims + " claims and are trusted on " + trustedClaims + " more.";
	}

	public static String starterKitStateLine(String starterKitState) {
		return "Starter kit: " + starterKitState;
	}

	public static String currentLocationLine(String locationSummary) {
		return "Current location: " + locationSummary;
	}
	...
	public static String claimOwnerLine(String ownerName) {
		return "Owner: " + ownerName;
	}

	public static String claimOwnerWithUuidLine(String ownerName, String ownerUuid) {
		return "Owner: " + ownerName + " (" + ownerUuid + ")";
	}

	public static String yourAccessLine(String access) {
		return "Your access: " + access;
	}

	public static String accessHereLine(String access) {
		return "Access here: " + access;
	}

	public static String claimSizeLine(int width, int depth) {
		return "Size: " + width + "x" + depth;
	}

	public static String claimBoundsLine(String bounds) {
		return "Bounds: " + bounds;
	}

	public static String claimCenterLine(String center) {
		return "Center: " + center;
	}

	public static String claimTrustedPlayersLine(String trustedSummary) {
		return "Trusted players: " + trustedSummary;
	}

	public static String claimCreatedLine(String timestamp) {
		return "Created: " + timestamp;
	}

	public static String claimLastActiveLine(String timestamp) {
		return "Last active: " + timestamp;
	}

	public static String noClaimsFound() {
		return "No claims found.";
	}

	public static String positiveWholeNumber(String label) {
		return label + " must be a positive whole number.";
	}

	public static String playerOnlySubcommand() {
		return "This subcommand can only be used in game.";
	}

	public static String claimAlreadyRemoved() {
		return "That claim was already removed.";
	}

	public static String claimTitleLine(String claimId) {
		return "Claim " + claimId;
	}
	...
	public static String claimExpiryRemovedNotice(int claimCount) {
		return claimCount == 1
			? "One safe zone expired while you were away and was removed."
			: claimCount + " safe zones expired while you were away and were removed.";
	}
